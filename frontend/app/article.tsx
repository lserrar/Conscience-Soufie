...
export default function ArticleScreen() {
  ...
  const articleTitle = typeof title === 'string' ? title : 'Article';
    ...
    return (
      <View style={[styles.container, { paddingTop: insets.top }]}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle} numberOfLines={1}>{articleTitle}</Text>
        ...
        <View style={styles.webFallback}>
          ...
          <Text style={styles.fallbackTitle} numberOfLines={2}>{articleTitle}</Text>
          <Text style={styles.fallbackText}>
            L'article s'affiche mieux dans l'application mobile.
          </Text>
          <TouchableOpacity style={styles.openButton} onPress={openInBrowser}>
            <Text style={styles.openButtonText}>Lire sur le site</Text>
